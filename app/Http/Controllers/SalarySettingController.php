...
class SalarySettingController extends Controller
{
    ...
    public function update(Request $request, $gymId, $id)
    {
        ...
        $newData = $request->only('base', 'course_fixed',  'course_fixed_configuration', 'sale_configuration', 'course_free', 'course_trial', 'course_percentage', 'sale_percentage', 'finished_percentage', 'tax');

...
{
    protected $fillable = [
        'created_by', 'base', 'course_free', 'course_trial', 'course_fixed', 'course_fixed_configuration', 'sale_configuration', 'course_percentage', 'sale_percentage', 'tax', 'gym_id', 'coach_id'
    ];

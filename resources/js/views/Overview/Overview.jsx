...
import { Avatar, ListItem, List, Grid, Tooltip } from '@mui/material';
...
const classes = {
    ...
    leftTitleContainer: `${PREFIX}-leftTitleContainer`,
    leftTitle: `${PREFIX}-leftTitle`,
    containerHeader: `${PREFIX}-containerHeader`,
    containerBody: `${PREFIX}-containerBody`,
    rightContainerBody: `${PREFIX}-rightContainerBody`,
    filterContainer: `${PREFIX}-filterContainer`,
    rightContainer: `${PREFIX}-rightContainer`,
    dotTabs: `${PREFIX}-dotTabs`,
    tabDescription: `${PREFIX}-tabDescription`,
    dotTab: `${PREFIX}-dotTab`,
    ...
    customerProfile: `${PREFIX}-customerProfile`,
    customerProfileName: `${PREFIX}-customerProfileName`,
    customerProfileLastSchedule: `${PREFIX}-customerProfileLastSchedule`,
    customerProfileCoach: `${PREFIX}-customerProfileCoach`,
    customerProfileHotmap: `${PREFIX}-customerProfileHotmap`,
    coachQuadrantFilter: `${PREFIX}-coachQuadrantFilter`,
    chartTitle: `${PREFIX}-chartTitle`,
    chartSubTitle: `${PREFIX}-chartSubTitle`,
    titleSeparator: `${PREFIX}-titleSeparator`,
    titleUnit: `${PREFIX}-titleUnit`,
    titleInactive: `${PREFIX}-titleInactive`,
    titleUnitInactive: `${PREFIX}-titleUnitInactive`,
    yearChartCard: `${PREFIX}-yearChartCard`,
    coachQuadrantCard: `${PREFIX}-coachQuadrantCard`,
    yearChart: `${PREFIX}-yearChart`,
    noData: `${PREFIX}-noData`,
    customerCardRow: `${PREFIX}-customerCardRow`,
    chart: `${PREFIX}-chart`,
...
const Root = styled('div')({
    ...
    [`& .${classes.customerProfile}`]: {
        flex: 2,
        paddingLeft: 12,
        paddingTop: 4
    },
    [`& .${classes.customerProfileName}`]: {
        fontSize: 14,
        fontWeight: 500,
        color: '#333',
        marginBottom: -2
    },
    [`& .${classes.customerProfileLastSchedule}`]: {
        fontSize: 12,
        fontWeight: 500,
        color: '#999'
    },
    [`& .${classes.customerProfileCoach}`]: {
        flex: 2,
        fontSize: 16,
        fontWeight: 900,
        color: '#666',
    ...
    [`& .${classes.customerProfileHotmap}`]: {
        flex: 2,
        minWidth: 60
    },
    [`& .${classes.coachQuadrantFilter}`]: {
        position: 'absolute',
        top: 6,
        right: 6,
        zIndex: 1000
    ...
    [`& .${classes.yearChartCard}`]: {
        position: 'relative',
        maxWidth: 740,
        paddingLeft: 0,
        paddingTop: 16
    },
    [`& .${classes.coachQuadrantCard}`]: {
        paddingTop: 16,
        position: 'relative',
        flex: 1
    },
...
class Overview extends React.Component {
    ...
    filterBar = () => {
        const { } = this.props
        return (
            <Root className={classes.leftTitleContainer}>
                <Titlebar label="数据" />
        ...
        return (
            <div className={classes.filterItem}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={'zh-cn'}>
                    {(() => {
                        const DateButton = React.forwardRef(function DateButton(props, ref) {

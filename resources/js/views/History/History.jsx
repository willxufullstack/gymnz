...
const classes = {
    hotMapTitle: `${PREFIX}-hotMapTitle`,
    monthLabelsContainer: `${PREFIX}-monthLabelsContainer`,
    monthLabel: `${PREFIX}-monthLabel`,
    customerDetail: `${PREFIX}-customerDetail`,
    customerRow: `${PREFIX}-customerRow`,
    customerRowLabel: `${PREFIX}-customerRowLabel`,
    customerRowValue: `${PREFIX}-customerRowValue`,
    filterItem: `${PREFIX}-filterItem`,
    filterTitle: `${PREFIX}-filterTitle`,
    filterDropdownIcon: `${PREFIX}-filterDropdownIcon`
};

const StyledLightTabs
 = styled(LightTabs
)({
    [`& .${classes.hotMapTitle}`]: {
        marginBottom: 12,
    ...
    [`& .${classes.customerRowLabel}`]: {
        fontWeight: '700',
        flex: 1
    },
    [`& .${classes.customerRowValue}`]: {
        flex: 1
    },
    [`& .${classes.filterItem}`]: {
        maxWidth: 150,
    ...
    generateDayHotMap = (title, mappedWithDate) => {
        ...
        return (
            <div key={title} style={{ marginBottom: 42 }}>
                <p className={classes.hotMapTitle}>{title}</p>
                <div className={classes.monthLabelsContainer}>
                    {monthLabels.map(m => (
                        <div key={m} className={classes.monthLabel}>
                            {m}
                        </div>
                    ))}
                </div>
